...
--------- | -------- | ----------- | ---- | --------
**ip_hostname_mac** | required | Filter (A dictionary object with key/value used to create a query string) for retrieving a subset of endpoint information. Multiple endpoints can be queried but unique keys need to be supplied (e.g. `endpointName`, `ip`, etc.). For complete list of keys check (<https://automation.trendmicro.com/xdr/api-v3#tag/Search/paths/~1v3.0~1eiqs~1endpoints/get>) | string | `ip` `mac address` `host name` `agent guid` |
...
**status** | required | The status of a case or investigation | string | |
**inv_result** | required | The findings of a case or investigation | string | |
...
action_result.parameter.workbench_id | string | `workbench id` | |
action_result.parameter.inv_result | string | | |
action_result.data.\*.message | string | | |
action_result.summary | string | | |
action_result.message | string | | |
summary.total_objects | numeric | | |
...
Retrieves a detailed list of endpoints from Vision One and displays rich endpoint details including EPP agent, EDR sensor, security policy, and more.

#### Action Parameters

PARAMETER | REQUIRED | DESCRIPTION | TYPE | CONTAINS
--------- | -------- | ----------- | ---- | --------
**query_op** | optional | Query operator (default: and) | string | |
**top** | optional | Number of records displayed per page (default: 100) | numeric | |
**filter** | optional | JSON dictionary of field/value used to filter results (e.g. {"osPlatform": "windows"}). For complete list of supported fields check (<https://automation.trendmicro.com/xdr/api-v3#tag/Endpoint-Security/paths/~1v3.0~1endpointSecurity~1endpoints/get>) | string | |

#### Action Output

DATA PATH | TYPE | CONTAINS | EXAMPLE VALUES
--------- | ---- | -------- | --------------
action_result.parameter.query_op | string | | |
action_result.status | string | | success failed |
action_result.data.\*.agent_guid | string | | |
action_result.data.\*.endpoint_name | string | | |
action_result.data.\*.display_name | string | | |
action_result.data.\*.os_name | string | | |
action_result.data.\*.os_platform | string | | |
action_result.data.\*.os_version | string | | |
action_result.data.\*.last_used_ip | string | | |
action_result.data.\*.ip_addresses | string | | |
...
Displays the detailed profile of a specified endpoint including OS info, network interfaces, EPP agent, EDR sensor, security policy, and more.

#### Action Parameters

PARAMETER | REQUIRED | DESCRIPTION | TYPE | CONTAINS
--------- | -------- | ----------- | ---- | --------
**endpoint_id** | required | The ID of the endpoint on the Vision One platform. For more details check (<https://automation.trendmicro.com/xdr/api-v3#tag/Endpoint-Security/paths/~1v3.0~1endpointSecurity~1endpoints~1%7BendpointId%7D/get>) | string | |
...
action_result.data.\*.last_used_ip | string | | |
action_result.data.\*.isolation_status | string | | |
action_result.data.\*.security_policy | string | | |
action_result.summary | string | | |
action_result.message | string | | |
summary.total_objects | numeric | | |
summary.total_objects_successful | numeric | | |
